// src/components/private/CourseFormDialog_mp.tsx
...
const schema = z.object({
  ...
  descripcion: z.string().min(10, 'MÃ­nimo 10 caracteres'),
  categoria: z.string().min(2, 'MÃ­nimo 2 caracteres'),
  fecha_inicio: z.string().min(1, 'Requerido'),
  fecha_fin: z.string().min(1, 'Requerido'),
  nivel: z.string().min(2, 'MÃ­nimo 2 caracteres'),
  precio: z.number().positive('Debe ser mayor a 0'),
  instructorNombre: z.string().min(2, 'MÃ­nimo 2 caracteres'),
  instructorEmail: z.string().email('Email invÃ¡lido'),
  requisitos: z.string().optional(),
  calificacion_promedio: z.number().min(0).max(5, 'MÃ¡ximo 5'),
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <Input id="nivel" placeholder="BÃ¡sico, Intermedio..." {...register('nivel')} />
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <Label htmlFor="calificacion_promedio">CalificaciÃ³n promedio</Label>
          ...
          <div>
            ...
            <Input id="requisitos" placeholder="JavaScript, TypeScript bÃ¡sico" {...register('requisitos')} />
          </div>
