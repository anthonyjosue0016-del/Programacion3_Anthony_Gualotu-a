// src/components/private/PostFormDialog_mp.tsx
...
const schema = z.object({
  ...
  content: z.string().min(10, 'MÃ­nimo 10 caracteres'),
  categoryId: z.string().uuid('Selecciona una categorÃ­a'),
})
            ...
            <Controller
              ...
              render={({ field }) => (
                <Select onValueChange={field.onChange} value={field.value}>
                  <SelectTrigger><SelectValue placeholder="Selecciona una categorÃ­a" /></SelectTrigger>
                  <SelectContent>
                    {categories.map((cat) => (
