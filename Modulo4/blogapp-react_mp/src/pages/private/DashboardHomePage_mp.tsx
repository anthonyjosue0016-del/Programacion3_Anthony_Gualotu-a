// src/pages/private/DashboardHomePage_mp.tsx
...
export default function DashboardHomePage() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      setCounts({
        ...
        cursos: cursos.items.length, // aproximado: /cursos no expone un total real (ver MÃ³dulo 5)
  ...
  const cards: CardConfig[] = [
    { label: 'CategorÃ­as', value: counts.categorias, icon: FolderKanban, borderClass: 'border-l-blue-500', iconClass: 'bg-blue-50 text-blue-600' },
