// src/pages/private/CategoriesPage_mp.tsx
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-4 p-8">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => { setEditing(null); setDialogOpen(true) }}>Nueva categorÃ­a</Button>
      </div>
      <Table>
        <TableHeader>
      ...
      <ConfirmDialog
        ...
        description={`Â¿Seguro que quieres eliminar "${deleteTarget?.name}"? Esta acciÃ³n no se puede deshacer.`}
