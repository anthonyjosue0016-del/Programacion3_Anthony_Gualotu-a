// src/pages/private/PostsPage_mp.tsx
...
export default function PostsPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-4 p-8">
      ...
      <Table>
        <TableHeader>
          <TableRow><TableHead>TÃ­tulo</TableHead><TableHead>CategorÃ­a</TableHead><TableHead /></TableRow>
        </TableHeader>
        <TableBody>
          {posts.map((post) => (
          ...
          {posts.length === 0 && (
            <TableRow><TableCell colSpan={3} className="text-center text-muted-foreground">No hay posts todavÃ­a.</TableCell></TableRow>
          )}
        </TableBody>
      </Table>
      <PostFormDialog
      ...
      <ConfirmDialog
        ...
        title="Eliminar post"
        description={`Â¿Seguro que quieres eliminar "${deleteTarget?.title}"? Esta acciÃ³n no se puede deshacer.`}
