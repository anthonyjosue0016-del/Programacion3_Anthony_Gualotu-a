// src/pages/public/HomePage_mp.tsx
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4">
        ...
        {posts.length === 0 && <p className="text-muted-foreground">No hay posts todavÃ­a.</p>}
      </div>
  ...
  return (
    <div className="space-y-6">
      <div className="grid gap-4">
        ...
        {courses.length === 0 && <p className="text-muted-foreground">No hay cursos todavÃ­a.</p>}
      </div>
      <div className="flex items-center justify-center gap-3">
        <Button variant="outline" disabled={page <= 1} onClick={() => setPage((p) => p - 1)}>Anterior</Button>
