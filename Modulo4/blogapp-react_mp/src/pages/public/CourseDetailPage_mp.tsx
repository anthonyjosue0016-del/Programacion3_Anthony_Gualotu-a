// src/pages/public/CourseDetailPage_mp.tsx
...
export default function CourseDetailPage() {
  ...
  return (
    <article className="mx-auto max-w-2xl space-y-4 p-8">
      <Link to="/" className="text-sm text-muted-foreground">â† Volver</Link>
      ...
      <div>
        ...
        {curso.contenidos.length === 0 && <p className="text-muted-foreground">Sin contenido cargado todavÃ­a.</p>}
