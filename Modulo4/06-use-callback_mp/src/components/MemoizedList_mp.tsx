...
const INITIAL_TASKS: Task[] = [
  { id: 1, text: 'DiseÃ±ar la interfaz',    completed: false },
  ...
  { id: 5, text: 'Deploy en producciÃ³n',   completed: false },
]
...
export default function MemoizedList() {
  ...
  }, []) // sin dependencias externas â€” setTasks es estable
  ...
  return (
    <div style={{ fontFamily: 'sans-serif', maxWidth: 520, margin: '0 auto', padding: 24 }}>
      ...
      <p style={{ color: '#666', fontSize: 14, marginBottom: 20 }}>
        <code>React.memo</code> + <code>useCallback</code> â€” las filas no re-renderizan por un counter ajeno.
      </p>
      ...
      <div style={{ display: 'flex', gap: 12, alignItems: 'center', marginBottom: 20 }}>
        ...
        <span style={{ fontSize: 13, color: '#888' }}>
          â† no debe re-renderizar las filas
        </span>
      </div>
      ...
      <p style={{ marginTop: 16, fontSize: 12, color: '#aaa' }}>
        ...
        {' '}(deberÃ­a crecer solo al hacer toggle o delete, no al pulsar el counter)
      </p>
    </div>
  )
}
