...
export default function PaginatedFetch() {
  ...
  const fetchPage = useCallback(async () => {
    ...
    setError(null)
    try {
      // JSONPlaceholder: _start y _limit para paginaciÃ³n
  ...
  }, [page]) // â† nueva funciÃ³n solo cuando page cambia
  ...
  return (
    <div style={{ fontFamily: 'sans-serif', maxWidth: 540, margin: '0 auto', padding: 24 }}>
      ...
      <p style={{ color: '#666', fontSize: 14, marginBottom: 20 }}>
        <code>useCallback</code> con <code>[page]</code> como dep â€” fetch al cambiar de pÃ¡gina.
      </p>
      ...
      <p style={{ textAlign: 'center', fontSize: 12, color: '#aaa', marginTop: 10 }}>
        PÃ¡gina {page} de {totalPages} Â· {total} usuarios en total
      </p>
    </div>
  )
}
