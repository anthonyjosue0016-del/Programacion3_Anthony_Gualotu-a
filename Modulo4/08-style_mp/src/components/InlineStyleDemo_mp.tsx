...
export default function InlineStyleDemo() {
  // CSSProperties tipa el objeto â€” TypeScript detecta errores al escribir
  ...
  return (
    <div style={card}>
      ...
      <p style={{ margin: 0, color: 'var(--muted)' }}>
        Estilos como objetos JS dentro del componente. Ãštil para valores dinÃ¡micos
