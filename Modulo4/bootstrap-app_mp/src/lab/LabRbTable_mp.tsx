...
const PRODUCTS: Product[] = [
  { id: 1, name: 'Teclado mecÃ¡nico',   category: 'PerifÃ©ricos', price: 89.99,  active: true  },
  { id: 2, name: 'Monitor 27"',        category: 'Pantallas',   price: 349.99, active: true  },
  { id: 3, name: 'Mouse inalÃ¡mbrico',  category: 'PerifÃ©ricos', price: 29.99,  active: false },
  { id: 4, name: 'Webcam HD',          category: 'CÃ¡maras',     price: 59.99,  active: true  },
  ...
  return (
    <Container className="py-4">
      ...
      <p className="text-secondary mb-3">
        Striped, hover, responsive y bÃºsqueda en tiempo real.
      </p>
