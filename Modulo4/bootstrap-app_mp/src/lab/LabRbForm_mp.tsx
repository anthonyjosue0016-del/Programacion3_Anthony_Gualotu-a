...
export default function LabRbForm() {
  ...
  function validate(): boolean {
    ...
    if (!values.email.includes('@'))  e.email = 'Email invÃ¡lido'
    setErrors(e)
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    setSuccess(true)
    setTimeout(() => {
        setSuccess(false), setValues({ name: '', email: '', role: 'viewer' })
    },3000)
  ...
  return (
    <Container className="py-4">
      ...
      <p className="text-secondary mb-3">Con validaciÃ³n manual y feedback visual.</p>

      {success && <Alert variant="success">âœ… Registro enviado correctamente</Alert>}
