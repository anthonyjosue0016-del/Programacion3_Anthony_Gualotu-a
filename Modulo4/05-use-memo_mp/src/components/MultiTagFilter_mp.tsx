...
const ARTICLES: Article[] = [
  { id: 1, title: 'IntroducciÃ³n a React Hooks',        tags: ['react', 'hooks', 'tutorial'],    views: 4200 },
  { id: 2, title: 'TypeScript con React: guÃ­a prÃ¡ctica',tags: ['typescript', 'react', 'guÃ­a'], views: 3100 },
  ...
  { id: 7, title: 'Performance en React: tÃ©cnicas clave',tags:['react', 'performance', 'hooks'],views: 3600 },
  { id: 8, title: 'TypeScript strict mode explicado',   tags: ['typescript', 'guÃ­a'],           views: 1500 },
]
  ...
  return (
    <div style={{ fontFamily: 'sans-serif', maxWidth: 580, margin: '0 auto', padding: 24 }}>
      ...
      <p style={{ color: '#666', fontSize: 14, marginBottom: 20 }}>
        Tags mÃºltiples con filtro AND. Conteos memoizados â€” se calculan una sola vez.
      </p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
        <span style={{ fontSize: 13, color: '#888' }}>
          {sorted.length} artÃ­culo{sorted.length !== 1 ? 's' : ''}
