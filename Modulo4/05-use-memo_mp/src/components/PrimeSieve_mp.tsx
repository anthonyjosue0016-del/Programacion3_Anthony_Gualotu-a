...
// Criba de EratÃ³stenes â€” complejidad O(n log log n)
  ...
  return (
    <div style={{ fontFamily: 'sans-serif', maxWidth: 520, margin: '0 auto', padding: 24 }}>
      ...
      <p style={{ color: '#666', fontSize: 14, marginBottom: 20 }}>
        El contador provoca re-renders â€” el cribado solo recorre cuando cambia el lÃ­mite.
      </p>
      ...
      <div style={{
        ...
        {[
          ...
          { label: 'LÃ­mite',             value: limit.toLocaleString() },
