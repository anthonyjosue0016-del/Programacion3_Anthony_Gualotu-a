...
const ORDERS: Order[] = [
  { id: 1, customer: 'Ana GarcÃ­a',    amount:  120.00, status: 'paid',     createdAt: '2024-01-15' },
  { id: 2, customer: 'Luis PÃ©rez',    amount:  340.50, status: 'paid',     createdAt: '2024-01-18' },
  { id: 3, customer: 'MarÃ­a LÃ³pez',   amount:   89.99, status: 'pending',  createdAt: '2024-01-20' },
  { id: 4, customer: 'Carlos Ruiz',   amount:  560.00, status: 'refunded', createdAt: '2024-01-22' },
  { id: 5, customer: 'Ana GarcÃ­a',    amount:  210.00, status: 'paid',     createdAt: '2024-02-01' },
  { id: 6, customer: 'SofÃ­a Torres',  amount:   75.00, status: 'pending',  createdAt: '2024-02-05' },
  { id: 7, customer: 'Luis PÃ©rez',    amount: 1100.00, status: 'paid',     createdAt: '2024-02-08' },
  { id: 8, customer: 'Elena DÃ­az',    amount:  290.00, status: 'paid',     createdAt: '2024-02-10' },
]
...
export default function OrderMetrics() {
  ...
  // Filtrado base â€” depende de statusFilter y minAmount
  ...
  // MÃ©tricas â€” cada una depende de visibleOrders
  ...
  return (
    <div style={{ fontFamily: 'sans-serif', maxWidth: 580, margin: '0 auto', padding: 24 }}>
      ...
      <p style={{ color: '#666', fontSize: 14, marginBottom: 20 }}>
        MÃºltiples <code>useMemo</code> independientes derivados de un filtro base.
      </p>
      ...
      <div style={{
        ...
        {[
          ...
          { label: 'Mayor pedido',     value: maxOrder ? `$${maxOrder.amount.toFixed(2)} (${maxOrder.customer})` : 'â€”' },
        ].map(({ label, value }) => (
          <div key={label} style={{
            padding: 14,
            background: '#f5f5f5',
