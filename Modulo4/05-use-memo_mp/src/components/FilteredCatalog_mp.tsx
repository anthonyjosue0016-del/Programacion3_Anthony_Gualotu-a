...
const CATALOG: Product[] = [
  { id:  1, name: 'Teclado mecÃ¡nico',     category: 'PerifÃ©ricos', price:  89.99, active: true,  stock: 15 },
  { id:  2, name: 'Monitor 27"',          category: 'Pantallas',   price: 349.99, active: true,  stock:  8 },
  { id:  3, name: 'Mouse inalÃ¡mbrico',    category: 'PerifÃ©ricos', price:  29.99, active: false, stock:  0 },
  { id:  4, name: 'Webcam HD',            category: 'CÃ¡maras',     price:  59.99, active: true,  stock: 22 },
  { id:  5, name: 'Auriculares BT',       category: 'Audio',       price: 149.99, active: true,  stock:  6 },
  { id:  6, name: 'MicrÃ³fono condensador',category: 'Audio',       price: 199.99, active: true,  stock:  3 },
  { id:  7, name: 'Hub USB-C 7 puertos',  category: 'PerifÃ©ricos', price:  44.99, active: false, stock:  0 },
  ...
  { id: 10, name: 'CÃ¡mara mirrorless',    category: 'CÃ¡maras',     price: 899.99, active: true,  stock:  2 },
]
...
export default function FilteredCatalog() {
  ...
  // useMemo 1 â€” filtrar (depende de search, onlyActive, category)
  ...
  // useMemo 2 â€” ordenar (depende de filtered y sortBy)
  ...
  const categories = useMemo(
    ...
    [] // El catÃ¡logo es estÃ¡tico â€” solo se calcula una vez
  )
  ...
  return (
    <div style={{ fontFamily: 'sans-serif', maxWidth: 600, margin: '0 auto', padding: 24 }}>
      ...
      <p style={{ color: '#666', fontSize: 14, marginBottom: 20 }}>
        Dos <code>useMemo</code> encadenados: filtrar â†’ ordenar.
      </p>
