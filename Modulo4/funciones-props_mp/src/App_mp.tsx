...
// â”‚  1  DigitalCounter    â€” estado numÃ©rico con step y reset            â”‚
// â”‚  2  SafeCounter       â€” forma funcional prev => prev + 1            â”‚
// â”‚  3  UserProfileForm   â€” estado con objeto + spread update           â”‚
// â”‚  4  TaskManager       â€” estado con array: filter, map, spread       â”‚
// â”‚  5  Carrito useState  â€” array de objetos + lÃ³gica en App_mp.tsx        â”‚
...
const catalog = [
  { id: 1, name: 'Teclado mecÃ¡nico',  price: 89.99 },
  { id: 2, name: 'Monitor 27"',       price: 349.99 },
  { id: 3, name: 'Mouse inalÃ¡mbrico', price: 29.99 },
]
