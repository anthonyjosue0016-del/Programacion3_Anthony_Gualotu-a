...
export default function Stopwatch() {
  ...
  // del interval â€” funciona igual en browser y Node.js.
  // Si se usara useState para el interval ID, cada setInterval/clearInterval
  // generarÃ­a un render innecesario.
  ...
  // El tipo genÃ©rico <HTMLInputElement> indica quÃ© nodo referencia
    ...
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12, width: '100%', maxWidth: 320 }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
          <small>Controlado â€” cada tecla dispara un render</small>
          <input
            value={value}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
          <small>No controlado â€” cero renders mientras se escribe</small>
          <input
        ...
        <p style={{ margin: 0, fontSize: 14, color: '#374151' }}>
          Renders: {renderCount.current} Â· Valor anterior: {previousTime}
        </p>
      </div>
