...
const PRODUCTS: Product[] = [
  { id: 1, name: 'Teclado mecÃ¡nico',  category: 'perifÃ©ricos',  price: 89  },
  { id: 2, name: 'Monitor 27"',       category: 'pantallas',    price: 349 },
  { id: 3, name: 'Mouse inalÃ¡mbrico', category: 'perifÃ©ricos',  price: 29  },
  { id: 4, name: 'Webcam HD',         category: 'cÃ¡maras',      price: 59  },
  { id: 5, name: 'Auriculares BT',    category: 'audio',        price: 149 },
]

export default function ProductsPage() {
  // useSearchParams sincroniza filtros con la URL
  // ?q=teclado&category=perifÃ©ricos queda en la barra del navegador
