...
const numeros1 = [10, 20, 30, 20, 40];

// indexOf — primera posición del valor, -1 si no existe
console.log(numeros1.indexOf(20));    // 1
console.log(numeros1.indexOf(99));    // -1

// lastIndexOf — última posición del valor
console.log(numeros1.lastIndexOf(20));  // 3

// includes — ¿existe el valor? devuelve boolean
console.log(numeros.includes(30));   // true
console.log(numeros1.includes(30));   // true
console.log(numeros1.includes(99));   // false

const frutas1 = ["manzana", "banana", "cereza"];

// forEach no devuelve nada (undefined)
frutas1.forEach((fruta, indice) => {
...
// Doblar cada número
const dobles = numeros2.map(n => n * 2);
